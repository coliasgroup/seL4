...
function(add_config_library prefix configure_template)
    ...
    add_custom_command(
        ...
        COMMAND
            "${PYTHON3}" "${CONFIG_HEADER_GEN_PATH}" "${config_yaml_file}" -o "${config_header_file}"
        DEPENDS
            "${CONFIG_HEADER_GEN_PATH}"
            "${config_yaml_file}"
    ...
    add_dependencies(${prefix}_Config ${prefix}_Gen)
    ...
    set_property(TARGET ${prefix}_Gen APPEND PROPERTY GENERATED_FILES "${config_yaml_file}" "${config_header_file}")
